                    ...
                    <div className={mu.row}>
                        ...
                        <span className={mu.info}>
                            ...
                            <p className={clsx(mu.p, mu.secondary)}>
                                ...
                                позволить себе принебрежения типами. Когда речь идёт о системе из сотен сущностей разной сложности, поддержка строгой типизации является ключевым критерием выбора.
                            </p>
                        </span>
                    </div>
                    <div className={mu.row}>
