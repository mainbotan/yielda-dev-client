    ...
    return (
        <>
            ...
            <p className={mu.p}>
               ...
               <br /><br />
               Так же для понимания выбранного стека нужно знать архитектурный контекст Yieldaa, для этого рекомендуем ознакомиться с топиками <Link className={mu.accent} href='/architecture'>архитектура Yieldaa!</Link>.
               <br /><br />
