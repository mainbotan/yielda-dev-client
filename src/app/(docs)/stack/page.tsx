    ...
    return (
        <>
            ...
            <p className={mu.p}>
               ...
               <br /><br />
               Так же для понимания выбранного стека нужно понимать архитектурный контекст Yieldaa, для этого рекомендуем ознакомиться с топиками <Link className={mu.accent} href='/arhitectur'>Базовые архитектурные принципы</Link>.
               <br /><br />
