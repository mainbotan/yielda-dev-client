...
export default function Page() {
    return (
        <>
            ...
            <div className={mu.p}>
                Этот топик тесно связан с главой <Link className={mu.accent} href='/arhitecture'>базовые архитектурные принципы</Link>. Для понимания общей концепции, и требований системы рекомендуем ознакомиться с ней до прочтения этого топика.
                <br /><br />
                ...
                <br /><br />
                Итак, здесь мы не будем подробно объяснять архитектуру Yieldaa!, но затронем основным инструменты, используемый для реализации гибкой инфраструктуры. 
